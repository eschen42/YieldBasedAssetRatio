...
Figure 2 illustrates these maximium and minimum stock percentage limits when the current yield for GS10 is 4.14% (i.e., $\textbf{T}$).
...
The top panel of Figure 5 shows the hypothetical results for 1911--2022; the YBAR produced returns roughly as well as the 85% stock allocation did since 1961.
...
Figure 6 presents the same data as Figure 5, but restricted to 1962--1985; the YBAR recovered much better from the hiccups in 1975 and 1980 than did any of the fixed-percentage stock allocations. The advantage of the 6% stock portfolio in 1962 and 1974 proved to be short lived.
