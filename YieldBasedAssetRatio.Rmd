...
> *In the ordinary common stock ... the margin of safety lies in an expected earning power considerably above the going rate for bonds*.^[Graham, 2003. *Op. cit.*, pp. 512--524. Italics added; e.g., Graham would assign a "25% margin of safety" to a stock with expected earning power of 5% *vs.* a 4% rate for bonds.]
...
Regardless of whether one uses the YBAR or a fixed-percentage stock allocation to manage volatile assets, these cannot fund near term expenses without undue exposure to the possibility of a considerable loss in their principal value.
