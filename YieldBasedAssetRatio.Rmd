...
- Buy stock incrementally (to reach minimum percentage) as the stock percentage falls below the minimum -- 6%; this is a practical utilization of Graham's "margin of safety".
- Sell stock incrementally (to reach maximum percentage) as the stock percentage exceeds the maximum + 6%; this reflects the "margin of folly", defined below.
...
Figure 2 illustrates these maximium and minimum stock percentage limits when the current yield for GS10 ($\textbf{S}$) is 4.14% (i.e., $\textbf{T}$).
...
Figure 6 presents the same data as Figure 5, but restricted to 1962--1985; the YBAR recovered much better from the hiccups in 1975 and 1980 than did any of the fixed-percentage stock allocations. The advantage of the 6% stock portfolio in 1962 proved to be short lived.
