...
-   that hypothetically would had a 1.92% CAGR for the 20 years beginning in September of 1961, and
...
- Initially, establish minimum and maximum stock percentages that vary with SP5000 earnings yield and nominal GS10 current yield.
- Do not trade stock when percentage of stock in the portfolio lies between the minimum and maximum stock percentages.
- Buy stock incrementally as the stock percentage falls below the minimum -- 6%; this is a practical utilization of Graham's "margin of safety".
- Sell stock incrementally as the stock percentage exceeds the maximum + 6%; this reflects the "margin of folly", defined below.
...
In 1953, Lucile Tomlinson described one endowment fund's "compromise solution" that augmented capital appreciation by staggering the "buy" and "sell" thresholds of a variable stock-percentage allocation.^[Tomlinson, 1953. *Op. cit.*, pp. 232-238.] On the basis of Graham's "central value", that investment formula provided a modestly large number of incremental steps when varying percentage of stock. In her test, its hypothetical annualized performance would have exceeded (by 115 basis points) that of a 50% stock portfolio for 1924--1952. However, for 1961--1981, that formula's resistance to stock-price declines and its potential for capital appreciation is hampered by its generous 40% minimum stock allocation and its limited 60% maximum percentage of stock (data not shown).
