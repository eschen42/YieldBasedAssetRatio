...
> Over the short term, volatile assets pose undue risk to their principal value.
...
> The program I propose with 25 percent of the portfolio in stocks and 25 percent in bonds, allowing the other 50 percent to fluctuate in accordance with the market, could be operated pretty well over the future, whether the business cycle is under better control or not.^["Benjamin Graham: Thoughts on Security Analysis" [transcript of lecture at the Northeast Missouri State University business school, March, 1972], Friends of Financial History, no. 42, March, 1991, pp. 8--10 and 28--29. [*https://archive.org/details/friendsoffinanci00rmsm_38/page/8/mode/2up *](https://archive.org/details/friendsoffinanci00rmsm_38/page/8/mode/2up).]
...
- For all 20-year periods since 1911, this formula's gain would have had a minimum that was substantially higher than minima for a 6% stock, 60% stock, or 85% stock portfolio.
...
- For this data set, there are only about five times that the YBAR can be subjected to performance tests under observed conditions where relatively reduced stock yield adversely affected intermediate return of stocks (1912, 1929, 1961--1963, 1988, and 1998).
  - No attempt was made to vary the amount or sequence of future returns. Because the lessons offered by the past are limited, so the reader must decide whether the analysis presented here is sufficiently thorough.
...
- No attempt is made here to compare the after-tax returns of a constant percentage allocation with those of a YBAR allocation. This analysis implicitly assumes that intermediate-to-long term investments are held in a tax-deferred or tax-exempt account.
