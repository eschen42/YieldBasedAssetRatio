...
- For this data set, there are only about five times that the YBAR can be subjected to performance tests under observed conditions where relatively reduced stock yield adversely affected stocks' intermediate return (1912, 1929, 1961--1963, 1988, and 1998).
  ...
  - No attempt was made to model future possibilities that (necessarily) would differ from the historical record with respect to either the amount or the sequence of investment returns.
...
- One aspect of this analysis applies unknowable future data to present decisions: the factor $\frac{2 \times B}{T}$ used in defining the minimum limit and the factor $\frac{3 \times B}{T}$ used in the maximum limit were deduced by inspecting performance during the entire 1911--2022 period.
