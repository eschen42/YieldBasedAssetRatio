...
- This formula would have had a 1.92% CAGR for the 20 years beginning in September of 1961.
...
- This formula and its parameters were developed and tested using the historical record since 1911, which is both a short interval from a statistical sampling perspective and a long interval with respect to what might be considered to be "the modern era".
...
Another companion term, "margin of reversion", reflects how stock earnings yield stands relative to historical expectation:
  ...
  $$
The retiree may wish to consider this potential "reversion volatility" as they contemplate funding their retirement from whatever remains in their portfolio.
...
Regardless of whether one uses the YBAR or a fixed-percentage stock allocation to manage volatile assets, these cannot fund near term expenses (within 20 years) without exposure to the possibility of a considerable loss in their principal value.
