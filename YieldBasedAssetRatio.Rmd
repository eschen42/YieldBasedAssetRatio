...
A retirement may last forty years or more; funding it requires a decumulation strategy that both supports ongoing spending and resists market downturns.  Although returns from aggressive investments may offer modest opportunities to increase funding for longer-term expenses, losses incurred at unfavorable times when funding near-term spending from a retirement portfolio may threaten principal that is earmarked to generate income in the distant future.^[Pfau, Wade D., 2023. *Retirement Planning Guidebook: Navigating the Important Decisions for Retirement Success.* Retirement Researcher Media. ISBN-13: 978-1-94-564015-5. [*https://retirementresearcher.com/books/*](https://retirementresearcher.com/books/)] In the near term, minimally volatile assets, insurance products (e.g., annuities), or buffer assets (e.g., home equity conversion mortgages) may be the retiree's best recourse to mitigate the risk that "market underperformance" poses to funding retirement successfully.^[*Ibid.*] Volatile assets can only be wisely dedicated to funding intermediate-term and long-term spending needs, yet one must decide how to allocate investments among volatile assets.
...
The next two figures illustrate the cumulative effect of this YBAR formula, a 6% stock allocation, a 60% allocation, and a 85% allocation, with monthly rebalancing for the fixed-percentage stock allocation strategies.  As indicated above, the YBAR was tested with a minimum stock percentage of 6% stock, a maximum of 85%, and a maximum reversion hazard of 25%.
...
- For this data set, there are only about five times that the YBAR can be subjected to performance tests under observed conditions where relatively reduced stock yield adversely affected intermediate return of stocks (1912, 1929, 1961--1963, 1988, and 1998).
  - No attempt was made to vary the amount or sequence of future returns. Because the lessons offered by the past are limited, the reader must decide whether the analysis presented here is sufficiently thorough.
